...
<html lang="en">
  ...
  <li class="nav-item pt-3 pb-3 p-2">
    ...
    <form class="form-signin" action="{{route('registerstore')}}" method="POST">
    @csrf
        <input name="login" type="text" style="margin-bottom:30px;"  class="form-control" placeholder="Username" >
        <input name="mail" type="mail" style="margin-bottom:30px;"  class="form-control" placeholder="E-main" >
        <input name="tel" type="tel" style="margin-bottom:30px;"  class="form-control" placeholder="Phone number" >
        <input name="pass" type="password" style="margin-bottom:30px;"  class="form-control" placeholder="Password" >
        <button class="btn btn-lg btn-primary btn-block" type="submit">Sign UP</button>
        <p class="mt-5 mb-3 text-muted">If you already have an account you can <a href="{{route('login')}}">Log in now</a> </p>
    </form>
